...
#include "inline_my_meas.h" // If this new measurement were part of the chroma library, this file would automatically be included by including chroma.h. As we are developing externally to the library we need to include it.
...
bool linkageHack(void)
{
  ...
  foo &= InlineMyMeasEnv::registerAll(); // which just links in the measurement into the code. Again, if we added this measurement to the Chroma library, this line would be done by the line 72
